...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Skid Hub BF Premium') then
        makefolder('Skid Hub BF Premium')
    end
    if not _G.Dis and not isfile('Skid Hub BF Premium/'..Name..'.json') then
        writefile('Skid Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Skid Hub BF Premium') and isfile('Skid Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Skid Hub BF Premium/'..Name..'.json'))
	...
	-- Old World
		...
		function CheckLevel()
			...
			if Three_World then
                ...
                elseif Lv >= 2375 and Lv <= 2424 or SelectMonster == "Candy Rebel [Lv. 2375]" then 
                ...
                elseif Lv >= 2425 or SelectMonster == "Candy Pirate [Lv. 2400]" then 
				...
				elseif Lv >= 2450 or SelectMonster == "Isle Outlaw [Lv. 2450]" then
		...
		function CheckLevel2()
			...
			if Three_World and not Auto_Raid then
				...
				elseif Lv >= 2225 and Lv <= 2249 or SelectMonster == "Cake Guard [Lv. 2225]" then 
					...
					TelePBoss(CFrameQ)
				elseif Lv >= 2250 and Lv <= 2299 or SelectMonster == "Cake Guard [Lv. 2225]" then 
                ...
                elseif Lv >= 2375 and Lv <= 2399 or SelectMonster == "Candy Rebel [Lv. 2375]" then 
					...
					TelePBoss(CFrameQ)
                elseif Lv >= 2400 and Lv <= 2449 or SelectMonster == "Candy Pirate [Lv. 2400]" then 
					Ms = "Candy Pirate [Lv. 2400]"
					NameQuest = "CandyQuest1"
					QuestLv = 1
					NameMon = "Candy Pirate"
                ...
                elseif Lv >= 2450 or SelectMonster == "Snow Demon [Lv. 2425]" then 
					...
					NameMon = "Snow Demon"
					CFrameQ = CFrame.new(-1148.7237548828125, 20.353158950805664, -14445.751953125)
					CFrameMon = CFrame.new(-897.0211181640625, 14.10739803314209, -14429.8798828125)
...
if IKAI then
	...
	SkidFPS.Name = "SkidFPS"
	SkidFPS.Parent = game.CoreGui
	SkidFPSFPS.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
	
	Skidtime.Name = "Skidtime"
	Skidtime.Parent = game.CoreGui
	Skidtime.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
	
	Framefps.Name = "Framefps"
	Framefps.Parent = SkidFPS
...
Closed.Image = "http://www.roblox.com/asset/?id=13679772493"
